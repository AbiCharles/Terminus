...
# Milestone 1 oracle: write the complete reference VM to /app/vm.c. A single
# correct vm_run implementation (covering loading/decoding plus the stack ops, ADD/SUB, PRINT/HALT and the decode/stack error cases, plus the rest) satisfies this
