...
# Milestone 2 oracle: write the complete reference VM to /app/vm.c. A single
# correct vm_run implementation (covering arithmetic (MUL/DIV/MOD/NEG with wrapping and div-by-zero), comparisons, and locals (LOAD/STORE), plus the rest) satisfies this
