...
# Milestone 1 oracle: write the full earthquake declustering CLI to /app/quake.c,
# compile it against libsqlite3, and exercise the `query` subcommand. Self-contained
