...
# Milestone 1 oracle: write the complete reference allocator to /app/allocator.c.
# A single correct implementation (arena allocation with xmalloc/xfree: 16-byte alignment, no overlap, bounds, no corruption)
