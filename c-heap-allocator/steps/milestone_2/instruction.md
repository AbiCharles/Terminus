...
All of the milestone 1 guarantees (alignment, non-overlap, in-bounds, no corruption of live blocks) still apply to every allocation, including those served from reused or split space.
