...
# Milestone 2 oracle: write the complete reference allocator to /app/allocator.c.
# A single correct implementation (block reuse, splitting, and xcalloc on top of the milestone 1 allocator)
