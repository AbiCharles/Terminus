...
# Milestone 2 oracle: write the complete reference library to /app/signal.c.
# A single correct implementation (covering the DFT and dominant-frequency detection (sig_dft, sig_dominant_bins), plus the rest) satisfies this
