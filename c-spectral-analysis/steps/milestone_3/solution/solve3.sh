...
# Milestone 3 oracle: write the complete reference library to /app/signal.c.
# A single correct implementation (covering spectral SNR, the mean confidence interval, and the acceptance gate, plus the rest) satisfies this
