...
The `duckdb` command-line shell is installed and on your `PATH` — run your SQL with it, e.g. `duckdb /app/graph.duckdb` (interactive) or `duckdb /app/graph.duckdb < your.sql`.
