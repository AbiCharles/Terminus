...
# Milestone 3 oracle: write the full earthquake declustering CLI to /app/quake
# (an executable Ruby script using the sqlite3 gem) and exercise the `report` subcommand.
